...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_GRAVE,       MT(MOD_LGUI, KC_A),MT(MOD_LALT, KC_R),MT(MOD_LCTL, KC_S),MT(MOD_LSFT, KC_T),KC_G,           KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_M,           MT(MOD_RSFT, KC_N),MT(MOD_RCTL, KC_E),MT(MOD_LALT, KC_I),MT(MOD_LGUI, KC_O),KC_UNDS,        
    ...
    LT(2, KC_SPACE),LT(4, KC_ENTER),KC_TRANSPARENT,                 KC_TRANSPARENT, KC_ENTER,       LT(3, KC_BSPC)
  ),
  [1] = LAYOUT_moonlander(
